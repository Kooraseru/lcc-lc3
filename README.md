...
This is the canonical authored source repository for LCC-LC3.
...
`.generated/docs/ja-JP/README.md`, and only mirrors the English document to
`.generated/README.md` for GitHub.
